...
//////////////////////////////////////////////////////////////
// Cleint1.cs - define noSQL database                       //
// Ver 1.1                                                  //
...
/*
this is the client that is used to read the data from the server and query the server
Public Interfaces:
...
namespace Project4Starter
{
    ...
    class Requirement
    {
        ...
        static void Main(string[] args)
        {
            ...
            Requirement clnt = new Requirement();
            ...
            Client_handling(clnt, rcvr, sndr);
        }

        private static void Client_handling(Requirement clnt, Receiver rcvr, Sender sndr)
        {
        ...
        private static void check_Message(Requirement clnt, Sender sndr, Message msg1)
        {
            clnt.d.Stop();
            Console.WriteLine("====================================================");
