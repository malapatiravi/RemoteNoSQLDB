...
namespace Project4Starter
{
  ...
  public class Sender
  {
    ...
    public virtual SWTools.BlockingQueue<Message> defineSendProcessing()
    {
      ...
      Action sendAction = () =>
      {
          ThreadStart sendThreadProc = Thread_Make_Method(sendQ);
      ...
      return sendQ;
        ...
        private ThreadStart Thread_Make_Method(SWTools.BlockingQueue<Message> sendQ)
        {
    ...
    static void Main(string[] args)
    {
      ...
      while (true)
      {
        ...
        msg.content = "Messager1 #" + (++counter).ToString();
      ...
      msg.fromUrl = sndr.localUrl;
      msg.toUrl = sndr.remoteUrl;
      msg.content = "Message r2#" + (++counter).ToString();
      Console.Write("\n  sending {0}", msg.content);
      sndr.sendMessage(msg);
      msg = new Message();
      msg.fromUrl = sndr.localUrl;
