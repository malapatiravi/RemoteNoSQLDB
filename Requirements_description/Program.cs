...
//////////////////////////////////////////////////////////////
// Cleint.cs - define noSQL database                       //
// Ver 1.1                                                  //
...
/*
this is the client to demonstrate all the requirments for Project2
Public Interfaces:
...
namespace Project4Starter
{
    ...
    class Client
    {
        ...
        static void Main(string[] args)
        {
            ...
            Sender sndr;
            Receiver rcvr;
            Client_Handling_before_start(args, out clnt, out sndr, out rcvr);
            ...
            {   if (Util.verbose)
                ...
                {   msg1 = rcvr.getMessage();   // note use of non-service method to deQ messages
                    ...
                    {
                        Client_Handling_done(clnt, sndr, msg1);
                    }
            ...
            Client_Handling(clnt, sndr, rcvr, msg, testmsg);
        }

        private static void Client_Handling_before_start(string[] args, out Client clnt, out Sender sndr, out Receiver rcvr)
        {
            Console.Write("\n  starting CommService client");
            Console.Write("\n =============================\n");
            Console.Title = "Requirments demonstration #1";
            clnt = new Client();
            sndr = new Sender(clnt.localUrl);
        ...
        private static void Client_Handling_done(Client clnt, Sender sndr, Message msg1)
        {
            clnt.d.Stop();
            Console.WriteLine("====================================================");
            ...
            Console.WriteLine("====================================================");
            Console.WriteLine("The requirments from 2 to 4 and requirments 7 and 8 have been successfully demonstrated");
            Console.WriteLine("Please scroll back all the requirements have been executed");
        ...
        private static void Client_Handling(Client clnt, Sender sndr, Receiver rcvr, Message msg, Message testmsg)
        {
            Console.Write("\n =============================\n");
            ...
            //for(int i = 0; i < testmsg.packageList.Count; i++)
            //{
            //    Console.WriteLine("This is it : {0}",testmsg.packageList[i].PackageID);
            ...
            clnt.TestR4(msg, testmsg, sndr);
            clnt.TestR5(msg, testmsg, sndr);
            clnt.TestR6(msg, testmsg, sndr);
            clnt.TestR7(msg, testmsg, sndr);
            clnt.TestR8(msg, testmsg, sndr);
            clnt.TestR9(msg, testmsg, sndr);
        ...
        public void TestR1(Message msg, Message testmsg, Sender sndr)
        {
            int counter = 0;
            Console.WriteLine("\n==================================================");
            Console.WriteLine("Demonstrating Requirment1");
            Console.WriteLine("\n==================================================");
